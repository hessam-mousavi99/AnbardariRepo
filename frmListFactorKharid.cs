...
namespace Anbardari
{
    public partial class frmListFactorKharid : Form
    {
        ...
        void display()
        {
            SqlDataAdapter da = new SqlDataAdapter("select Distinct CodeFactor,TarikhFactor,NameMoshtari,JameFactor,Tozih from FactorKharid where TarikhFactor between '" + txtAzTarikh.Text + "' And '" + txtTaTarikh.Text + "'", con);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            Report1.Load("Report/ReportGozareshFactorKharid.mrt");
            Report1.Compile();
