    ...
    public partial class frmChekDaryafti : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "insert into ChekDaryafti (ShomareHesab,NameHesab,ShomareSanad,Mablagh,TarikhSabt,SarResid,NameMoshtari,Vaziat,Tozih) values (@a,@b,@c,@d,@e,@f,@g,@h,@i)";
                ...
                cmd.Parameters.AddWithValue("@g", txtDaryaftAz.Text);
        ...
        private void btnEdite_Click(object sender, EventArgs e)
        {
            try
            {
                cmd.Connection = con;
                cmd.Parameters.Clear();
                cmd.CommandText = "update ChekDaryafti set ShomareHesab='" + txtShomareHesab.Text + "',NameHesab=N'" + txtNameHesab.Text + "',ShomareSanad='" + txtShomareSanad.Text + "',Mablagh='" + txtMablagh.Text + "',TarikhSabt='" + txtTarikhSabt.Text + "',SarResid='" + txtTarikhsarresidChek.Text + "',NameMoshtari=N'" + txtDaryaftAz.Text + "',Vaziat=N'" + cmbVaziat.Text + "',Tozih=N'" + txtTozih.Text + "' where IdChek=" + txtId.Text;
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
                MessageBoxFarsi.Show("عملیات با موفقیت انجام شد.", "پیغام", MessageBoxFarsiButtons.OK, MessageBoxFarsiIcon.Information, MessageBoxFarsiDefaultButton.Button1);
